    ...
    <div class="h-screen flex gap-10 items-center justify-center lg:px-10">
        <div class="left-col w-1/2 flex flex-col gap-y-8 items-center">
            ...
            <div class="numKeypad w-full grid grid-cols-3 gap-4">
                <div class="key bg-white rounded-full text-black text-center p-4" :class="(typeof key == 'number') ? 'font-bold' : 'bg-blue-800 text-white'" v-for="(key, index) in keyPad" :key="index" @click="keyPress(key)">
